...
## 1.0.2
De Mistral API-sleutel wordt niet meer naar de browserconsole geschreven terwijl een beheerder de plugin configureert. Dat gebeurde bij elke toetsaanslag. Deze versie wijzigt alleen het frontend-pakket; de backend blijft op 1.0.1.
